...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image:alt", content: "Wizard Ops — lifetime software for local field-service businesses." },
      ...
      { name: "twitter:image:alt", content: "Wizard Ops — lifetime software for local field-service businesses." },
